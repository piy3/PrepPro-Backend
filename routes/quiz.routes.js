...
import { generateQuiz, getQuiz,getCurrentQuiz,submitQuiz, getQuizAttempts } from "../controller/quiz.controller.js";
...
quizRoutes.route('/getquizattempts/:quizId').get(getQuizAttempts)
